    ...
    <main className="app">
      ...
      <section className="hero">
        ...
        {discovery ? (
          ...
          <>
            <button className="pulse-button" onClick={pulse} aria-label="Pulse"><span className="pulse-ring ring-one" /><span className="pulse-ring ring-two" /><span className="pulse-core">PULSE</span></button>
