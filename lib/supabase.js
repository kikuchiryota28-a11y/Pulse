...
const client = createClient(SUPABASE_URL, SUPABASE_KEY, {
  auth: {
    // Pulse is a client-side Next.js app. Use the browser-native implicit
    // session flow so OAuth and magic-link redirects can be consumed directly
    // from the URL without requiring a server callback/cookie bridge.
    persistSession: true,
