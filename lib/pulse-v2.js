...
export const START_TASK = Object.freeze({
  ...
  prompt: 'Take one photo of the street or scene around you. Leave the next person something to act on.',
  hint: 'Avoid people, selfies, private information, and dangerous or restricted places.',
});
...
export function starterPayload(photoData, creatorId = null) {
  return {
    ...
    result: { dataUrl: photoData, summary: 'Initial place photo' },
